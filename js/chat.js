...
mdHtml.renderer.rules.paragraph_open = function (tokens, idx) {
    ...
    if (tokens[idx].lines && tokens[idx].level === 0) {
        ...
        return '<span class="call_type call_type2"><img src="/assets/ai.png" alt=""></span><p class="line" data-line="' + line + '">';
    }
    return '<p>';
};
...
$(document).ready(function () {
        ...
        function streaming() {
            ...
            es.onmessage = function (event) {
                if (isstarted) {
                    ...
                    $("#q" + answer).children('pre').before('<span class="call_type"><img src="/assets/pic.png" alt=""></span>');
 ...
 $('.el-tooltip').css('display', 'none');
  ...
  $('.xszg').css('display', 'none');
     ...
     $(".cxsycs").click(function () {//查询余额
        var prompt = $.cookie("dengluname");
        ...
        $.ajax({
            ...
            success: function (results) {
                ...
                layer.msg('剩余次数:'+results.sycs,{icon: 6,time:5000});
